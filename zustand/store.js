...
const useStore = create(
  persist((set) => ({
      ...
      isAuthenticated: '',
      dob: '',
      setPolicyHolderFirstName: (policyHolderFirstName) => set({ policyHolderFirstName }),
      setPolicyHolderLastName: (policyHolderLastName) => set( { policyHolderLastName }),
      setPolicyHolderDob: (policyHolderDob) => set( { policyHolderDob }),
      setIsPolicyCardHolder: (isPolicyCardHolder) => set({ isPolicyCardHolder }),
      setPolicyHolderRelation: (policyHolderRelation) => set({ policyHolderRelation }),
