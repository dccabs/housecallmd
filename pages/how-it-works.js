...
const HowItWorksPage = () => {
  ...
  return (
    <>
      <NextSeo
        title="How it works | House Call MD"
        description="How it works in House Call MD."
        ...
        openGraph={{
          ...
          description: 'How it works in House Call MD',
          locale: 'en_US',
          url: `https://www.housecallmd.org/how-it-works`,
        }}
      />
            ...
            >
                ...
                <Card className={classes.stretch}>
                  ...
                  <CardContent>
                    <Typography gutterBottom>
                      Many simple medical issues can be handled via
                      telemedicine. Issues that are appropriate for telemedicine
                      can range from pinkeye, sinusitis, rashes, constipation,
                      diarrhea, nausea, back pain, shingles, and simple
                      medication refills among others. The medical provider can
                      evaluate your symptoms and send a prescription
                      electronically to your local pharmacy for immediate
                      pickup.
                    </Typography>
                    <Box mt="2em">
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Card className={classes.stretch}>
                  ...
                  <CardContent>
                    <Typography gutterBottom>
                      The level of care sends a medical technician to your home
                      to help the doctor perform the exam using technology
                      (digital stethoscope and otoscope). They can order on-site
                      testing as well as medical treatments like nebulizers,
                      injections, or wound care. The medical technician can also
                      dispense your prescription for you, so you don’t have to
                      go to the pharmacy after the visit. Most medical issues
                      can be treated with this level of care.
                    </Typography>
                    <Box mt="2em">
                      <Typography style={{ fontWeight: 600 }}>
            ...
            <Grid item md={6}>
              <Box py="2em" m="auto" alignItems="center">
                ...
                <Typography>
                  ...
                  that you need an on-site visit or testing, they can arrange
                  for staff to come to you or schedule you for an in-person
